...
print(Sys.time())
devtools::load_all()
p_sorted_fixed_columns <- plot_alluvial(clus_df_gather_summed, graphing_columns = graphing_columns_summed, column_weights = "value", sorting_algorithm = "neighbornet", optimize_column_order = optimize_column_order, color_bands=TRUE, verbose=TRUE)
print(Sys.time())
...
print(Sys.time())
p_sorted_optimized_columns <- plot_alluvial(clus_df_gather, graphing_columns = graphing_columns, column_weights = "value", sorting_algorithm = "neighbornet", optimize_column_order = optimize_column_order, color_bands=TRUE)
print(Sys.time())
