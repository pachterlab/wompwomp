...
```{r}
clus_df_gather_sorted <- sort_to_uncross(df, cols = c("tissue", "cluster"), method = "greedy_wolf", fixed_column = "tissue")
...
```{r}
clus_df_gather_sorted <- sort_to_uncross(df, cols = c("tissue", "cluster"), method = "greedy_wblf", options = sort_to_uncross_options(random_initializations = 10))
