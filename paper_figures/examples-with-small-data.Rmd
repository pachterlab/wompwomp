...
plot_alluvial(df, graphing_columns = graphing_columns, sorting_algorithm = "neighbornet", color_bands = TRUE, optimize_column_order = FALSE, optimize_column_order_per_cycle = TRUE, weight_scalar = 1, alpha = 1e6, resolution = 2, output_plot_path = file.path(output_dir, "3layer_NN_fixed_columns.pdf"), verbose = TRUE)
```
...
# graph what I did above
plot_alluvial(df, graphing_columns = graphing_columns, sorting_algorithm = "neighbornet", color_bands = TRUE, optimize_column_order = TRUE, optimize_column_order_per_cycle = TRUE, weight_scalar = 1, alpha = 1e6, resolution = 2, output_plot_path = file.path(output_dir, "3layer_NN_optimized_columns.pdf"), verbose = TRUE)
```
...
```{r}
plot_alluvial(df, graphing_columns = graphing_columns, sorting_algorithm = "neighbornet", color_bands = TRUE, optimize_column_order = FALSE, optimize_column_order_per_cycle = TRUE, weight_scalar = 1, alpha = 1e6, resolution = 2, verbose = TRUE)
```

```{r}
plot_alluvial(df, graphing_columns = graphing_columns, sorting_algorithm = "neighbornet", color_bands = TRUE, optimize_column_order = TRUE, optimize_column_order_per_cycle = TRUE, weight_scalar = 1, alpha = 1e6, resolution = 2, verbose = TRUE)
```
...
plot_alluvial(df, graphing_columns = graphing_columns, sorting_algorithm = "none", optimize_column_order = FALSE, color_bands = TRUE, color_band_column = "tissue", color_band_list = c("BRAIN" = "#D55E00", "HEART" = "#56B4E9", "STOMACH" = "#009E73"), color_boxes = FALSE, verbose = TRUE, output_plot_path = file.path(output_dir, "tutorial_3_unsorted.pdf"))
```
...
clus_df_gather <- sort_to_uncross(df, cols = graphing_columns, method = "neighbornet")
compute_crossing_objective(clus_df_gather, cols = graphing_columns)$output_objective
