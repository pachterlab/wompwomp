...
Optional:
  ...
  --column_sorting_algorithm Character. Algorithm to use for determining column order. Options are 'tsp' (default) or 'neighbornet'. Only applies when sorting_algorithm == 'neighbornet' and optimize_column_order is TRUE.
