...
sort_neighbornet <- function(clus_df_gather, graphing_columns = NULL, column_weights = "value", optimize_column_order = TRUE, optimize_column_order_per_cycle = FALSE, verbose = FALSE, make_intermediate_neighbornet_plots = FALSE) {
...
plot_alluvial <- function(df, graphing_columns = NULL, column1 = NULL, column2 = NULL, 
                          ...
                          fixed_column = NULL, random_initializations = 1, set_seed = 42, color_boxes = TRUE, 
                          color_bands = FALSE, color_list = NULL, color_band_list = NULL, color_band_column = NULL, 
                          color_band_boundary = FALSE, match_colors = TRUE, alluvial_alpha = 0.5, include_labels_in_boxes = TRUE, 
                          include_axis_titles = TRUE, include_group_sizes = TRUE, output_plot_path = NULL, output_df_path = NULL, 
                          preprocess_data = TRUE, box_width = 1 / 3, text_width = 1 / 4, min_text = 4, save_height = 6, save_width = 6, 
                          verbose = FALSE, make_intermediate_neighbornet_plots = FALSE, keep_y_labels=FALSE, box_line_width=2) {
    #* Type Checking Start
    # ensure someone doesn't specify both graphing_columns and column1/2
    if (!is.null(graphing_columns) && (!is.null(column1) || !is.null(column2))) {
        stop("Specify either graphing_columns or column1/column2, not both.")
    ...
    alluvial_plot <- plot_alluvial_internal(clus_df_gather,
        ...
        keep_y_labels=keep_y_labels, box_line_width=box_line_width
    )
