...
p1 <- plot_alluvial(clus_df_gather, graphing_columns = c("tissue", "cluster"), column_weights = "value", sorting_algorithm = "none", color_boxes = FALSE, color_bands = TRUE, coloring_algorithm = "none", color_band_list = c("B CELL" = "#D55E00", "BRAIN" = "#56B4E9", "HEART" = "#009E73", "STOMACH" = "#F0E442", "T CELL" = "#0072B2"), output_plot_path = file.path(output_dir, "intro_unsorted.pdf"), text_size = 15, axis_text_size = 25, axis_text_vjust = 0)
p1
