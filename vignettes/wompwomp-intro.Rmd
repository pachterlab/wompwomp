...
p4 <- plot_alluvial(clus_df_gather, graphing_columns = c("tissue", "cluster"), column_weights = "value", sorting_algorithm = "neighbornet", color_bands=TRUE, output_plot_path = file.path(output_dir, "intro_NN.pdf"))  # output_plot_path = "vignette_intro_plot.png"
