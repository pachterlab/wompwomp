...
p_unsorted <- plot_alluvial(clus_df_gather, graphing_columns = graphing_columns, column_weights = "value", sorting_algorithm = "None", color_bands = TRUE, color_boxes = FALSE, match_order = "left", resolution = 12, verbose = TRUE, output_plot_path = file.path(output_dir, "8_cubed_full_unsorted.pdf"), min_text = 0.01, save_height = 24, save_width = 24)
p_unsorted
```
...
print(Sys.time())
p_sorted_fixed_columns <- plot_alluvial(clus_df_gather, graphing_columns = graphing_columns, column_weights = "value", sorting_algorithm = "neighbornet", optimize_column_order = optimize_column_order, optimize_column_order_per_cycle = optimize_column_order_per_cycle, match_order = "left", resolution = 12, color_bands = TRUE, color_boxes = FALSE, verbose = TRUE, output_plot_path = file.path(output_dir, "8_cubed_full_NN_fixed_columns.pdf"), min_text = 0.01, save_height = 24, save_width = 24)
print(Sys.time())
...
print(Sys.time())
p_sorted_optimized_columns <- plot_alluvial(clus_df_gather, graphing_columns = graphing_columns, column_weights = "value", sorting_algorithm = "neighbornet", optimize_column_order = optimize_column_order, optimize_column_order_per_cycle = optimize_column_order_per_cycle, match_order = "left", resolution = 12, color_bands = TRUE, color_boxes = FALSE, verbose = TRUE, output_plot_path = file.path(output_dir, "8_cubed_full_NN_optimized_columns.pdf"), min_text = 0.01, save_height = 24, save_width = 24)
print(Sys.time())
...
print(Sys.time())
p_sorted_optimized_columns_trimmed <- plot_alluvial(clus_df_gather_summed, graphing_columns = graphing_columns_summed, column_weights = "value", sorting_algorithm = "neighbornet", optimize_column_order = optimize_column_order, optimize_column_order_per_cycle = optimize_column_order_per_cycle, color_bands = TRUE, color_band_column = "Gene", color_band_list = c("#D55E00", "#56B4E9"), color_boxes = FALSE, match_order = "None", verbose = TRUE, output_plot_path = file.path(output_dir, "8_cubed_trimmed_NN_optimized_columns.pdf"), min_text = 0.01, save_height = 24, save_width = 24)
...
print(Sys.time())
p_sorted_optimized_columns_trimmed2 <- plot_alluvial(clus_df_gather_summed2, graphing_columns = graphing_columns_summed2, column_weights = "value", sorting_algorithm = "neighbornet", optimize_column_order = optimize_column_order, optimize_column_order_per_cycle = optimize_column_order_per_cycle, color_bands = TRUE, color_band_column = "Gene", color_band_list = c("#D55E00", "#56B4E9"), color_boxes = FALSE, match_order = "None", verbose = TRUE, output_plot_path = file.path(output_dir, "8_cubed_trimmedX2_NN_optimized_columns.pdf"), text_size = 35, axis_text_size = 35, axis_text_vjust = -5, min_text = 0.01, save_height = 24, save_width = 24)
print(Sys.time())
...
```{r}
setwd("/Users/joeyrich/Desktop/local/wompwomp")
reticulate::use_condaenv("wompwomp_env", required = TRUE) # !!! erase
devtools::load_all() # !!! erase
...
# ./exec/wompwomp plot_alluvial --df '/Users/joeyrich/Downloads/alluvial_df.csv' --graphing_columns sex Age celltype_final --column_weights umi_total -o '/Users/joeyrich/Downloads/alluvial.png'
eight_cubed_file_path_new <- '/Users/joeyrich/Desktop/cube/alluvial_df.csv'
clus_df_gather <- read.csv(eight_cubed_file_path_new)
# clus_df_gather$umi_total <- sample(0:10, size = nrow(clus_df_gather), replace = TRUE)
# write.csv(clus_df_gather, file = "/Users/joeyrich/Desktop/cube/alluvial_df_better_umi.csv", row.names = FALSE)
plot_alluvial(clus_df_gather, graphing_columns=c("sex", "Age", "celltype_final"), column_weights="umi_total", output_plot_path="/Users/joeyrich/Downloads/alluvial.png", sorting_algorithm="tsp", match_order="left")
```
