---
title: "Plotting wompwomp Results with ggalluvial"
output:
    rmarkdown::html_vignette:
        toc: true
        toc_depth: 2
vignette: >
  %\VignetteIndexEntry{Plotting wompwomp Results with ggalluvial}
...
## Calling wompwomp from inside ggalluvial
...
parameters of `stat_stratum()`, `stat_alluvium()` and `stat_flow()`. See
`vignette("ggalluvial_integration")`.
