...
```{r}
plot_alluvial(df, graphing_columns = graphing_columns, sorting_algorithm = "neighbornet", match_colors_algorithm = "clustering", color_bands=TRUE, color_band_column = "tissue", color_band_list = c("#D55E00", "#56B4E9", "#009E73"), color_boxes = TRUE, verbose = TRUE, output_plot_path = file.path(output_dir, "tutorial_2_NN.pdf"))
```
...
```{r}
devtools::load_all()
plot_alluvial(df, graphing_columns = graphing_columns, sorting_algorithm = "neighbornet", color_bands=TRUE, match_colors_algorithm = "clustering", color_band_column = "tissue", color_band_list = c("#D55E00", "#56B4E9", "#009E73"), color_boxes = FALSE, verbose = TRUE, optimize_column_order = TRUE, optimize_column_order_per_cycle = TRUE, output_plot_path = file.path(output_dir, "tutorial_3_NN.pdf"))
```
