...
plot_alluvial(df, graphing_columns = graphing_columns, sorting_algorithm = "None", color_bands=TRUE, output_plot_path = file.path(output_dir, "3layer_unsorted.pdf"))
```
...
devtools::load_all()
plot_alluvial(df, graphing_columns = graphing_columns, sorting_algorithm = "neighbornet", color_bands=TRUE, optimize_column_order=FALSE, optimize_column_order_per_cycle=TRUE, output_plot_path = file.path(output_dir, "3layer_NN_fixed_columns.pdf"))
```
...
# graph what I did above
plot_alluvial(df, graphing_columns = graphing_columns, sorting_algorithm = "neighbornet", color_bands=TRUE, optimize_column_order=TRUE, optimize_column_order_per_cycle=TRUE, output_plot_path = file.path(output_dir, "3layer_NN_optimized_columns.pdf"))
```
