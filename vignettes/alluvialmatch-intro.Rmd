...
#     theme_minimal()
# p1
p1 <- plot_alluvial(clus_df_gather, graphing_columns = c("tissue", "cluster"), column_weights = "value", sorting_algorithm = "None", color_bands=TRUE)
p1

# ggsave("alluvialmatch_unsorted.png", plot = p1, dpi = 300, bg = "white")
```
...
```{r}
p2 <- plot_alluvial(clus_df_gather, graphing_columns = c("tissue", "cluster"), column_weights = "value", sorting_algorithm = "greedy_WOLF", fixed_column = 1, color_bands=TRUE)
...
```{r}
p3 <- plot_alluvial(clus_df_gather, graphing_columns = c("tissue", "cluster"), column_weights = "value", sorting_algorithm = "greedy_WBLF", color_bands=TRUE)  # output_plot_path = "vignette_intro_plot.png"
...
p4 <- plot_alluvial(clus_df_gather, graphing_columns = c("tissue", "cluster"), column_weights = "value", sorting_algorithm = "neighbornet", color_bands=TRUE)  # output_plot_path = "vignette_intro_plot.png"
# alternatively: p3 <- plot_alluvial(df, graphing_columns = c("tissue", "cluster"), sorting_algorithm = "neighbornet")
p4

# ggsave("alluvialmatch_NN.png", plot = p4, dpi = 300, bg = "white")
```
