...
crossing_edges_unsorted <- determine_crossing_edges(clus_df_gather_ungrouped, column1="tissue", column2="cluster", column_weights = "value")
# str(crossing_edges_unsorted[1:3])

crossing_edges_wolf <- determine_crossing_edges(clus_df_gather_sorted_wolf, column1="tissue", column2="cluster", column_weights = "value")
# str(crossing_edges_wolf[1:3])

crossing_edges_wblf <- determine_crossing_edges(clus_df_gather_sorted_wblf, column1="tissue", column2="cluster", column_weights = "value")  # output_df_path = "vignette_intro_crossing_wblf.csv"
