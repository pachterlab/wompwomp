...
```{r}
devtools::load_all()
df1 <- determine_crossing_edges(df="/Users/joeyrich/Desktop/local/alluvialmatch/tmp_files/clus_df_gather_new2.csv", column1="tissue", column2="leiden", output_df_path="/Users/joeyrich/Desktop/local/alluvialmatch/tmp_files/crossing3.csv")
df2 <- determine_crossing_edges(df="/Users/joeyrich/Desktop/local/alluvialmatch/tmp_files/clus_df_gather_new2.csv")
df3 <- determine_crossing_edges(df="/Users/joeyrich/Desktop/local/alluvialmatch/tests/testthat/ground_truth/sorting_wblf_df.csv", column1="col1_int", column2="col2_int")
```
