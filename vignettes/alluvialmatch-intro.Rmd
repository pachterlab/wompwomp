...
```{r}
clus_df_gather_sorted_wolf <- greedy_wolf(clus_df_gather, column1="tissue", column2="cluster", column_weights = "value", sorting_algorithm = "WOLF")
clus_df_gather_sorted_wolf
```

Plot the alluvial plot with sorting and color matching
```{r}
p2 <- plot_alluvial(clus_df_gather, column1="tissue", column2="cluster", column_weights = "value", sorting_algorithm = "WOLF", fixed_layer = 1)
# alternatively: p2 <- plot_alluvial(df, column1="tissue", column2="cluster", sorting_algorithm = "WOLF", fixed_layer = 1)
p2
```
...
```{r}
clus_df_gather_sorted_wblf <- greedy_wolf(clus_df_gather, column1="tissue", column2="cluster", column_weights = "value", sorting_algorithm = "WBLF")
clus_df_gather_sorted_wblf
```

```{r}
p3 <- plot_alluvial(clus_df_gather, column1="tissue", column2="cluster", column_weights = "value", sorting_algorithm = "WBLF")
# alternatively: p3 <- plot_alluvial(df, column1="tissue", column2="cluster", sorting_algorithm = "WBLF")
```
...
```{r}
crossing_edges_wolf <- determine_crossing_edges(clus_df_gather_sorted_wolf, column1="tissue", column2="leiden", column_weights = "value")
print(crossing_edges_wolf)

crossing_edges_wblf <- determine_crossing_edges(clus_df_gather_sorted_wblf, column1="tissue", column2="leiden", column_weights = "value")
print(crossing_edges_wblf)
```

```{r}
objective_wolf <- determine_weighted_layer_free_objective(crossing_edges_wolf)
print(objective_wolf)

objective_wblf <- determine_weighted_layer_free_objective(crossing_edges_wblf)
print(objective_wblf)
```
