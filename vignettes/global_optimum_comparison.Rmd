...
ggplot(df_plot, aes(x = perm_id, y = objective)) +
  ...
  annotate("text", x = Inf, y = wompwomp_objective_greedy_wolf, label = "wompwomp objective", 
...
ggplot(df_plot, aes(x = perm_id, y = objective)) +
  ...
  annotate("text", x = Inf, y = wompwomp_objective_greedy_wblf, label = "wompwomp objective", 
           hjust = 1.1, vjust = -0.5, color = "blue", size = 3) +
