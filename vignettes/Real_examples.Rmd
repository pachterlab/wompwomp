...
plot_alluvial(df, graphing_columns = graphing_columns, sorting_algorithm = "None", color_bands=TRUE, verbose=TRUE, auto_adjust_text=FALSE, output_plot_path = 'Segmentation_unsorted.pdf')
```

```{r}
devtools::load_all()
plot_alluvial(df, graphing_columns = graphing_columns, sorting_algorithm = "neighbornet", color_bands=TRUE, verbose=TRUE, auto_adjust_text=FALSE)
```
...
```{r}
p <- plot_alluvial(df, graphing_columns = graphing_columns, sorting_algorithm = "None", color_bands=TRUE, verbose=TRUE, output_plot_path='GoT_unsorted.pdf')
p
```
...
git commit -m "added hyperparameters for neighbornet distance matrix modification"
```{r}
