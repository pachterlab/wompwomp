...
```{r}
p <- plot_alluvial(df_shuffled, graphing_columns = graphing_columns, sorting_algorithm = "random", color_bands=FALSE, verbose=TRUE, output_plot_path=file.path(output_dir, "GoT_unsorted_shuffled.pdf"), min_text = 0.01, save_height = 24, save_width = 24)
p
```
