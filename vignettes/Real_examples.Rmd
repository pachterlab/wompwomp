...
p <- plot_alluvial(df, graphing_columns = graphing_columns, sorting_algorithm = "None", match_order = "advanced", color_bands=TRUE, resolution = 1, graphing_algorithm = "leiden", verbose=TRUE, output_plot_path = file.path(output_dir, "Segmentation_unsorted.pdf"), min_text = 0.01, save_height = 24, save_width = 24)
p
```
