...
p <- plot_alluvial(df, graphing_columns = graphing_columns, sorting_algorithm = "None", match_order = "advanced", color_bands=TRUE, resolution = 4, verbose=TRUE, output_plot_path = file.path(output_dir, "Segmentation_unsorted.pdf"), min_text = 0.01, save_height = 24, save_width = 24)
p
```

```{r}
p <- plot_alluvial(df, graphing_columns = graphing_columns, sorting_algorithm = "neighbornet", color_bands=TRUE, resolution = 4, verbose=TRUE, output_plot_path = file.path(output_dir, "Segmentation_NN.pdf"), min_text = 0.01, save_height = 24, save_width = 24)
p
```
...
```{r}
p <- plot_alluvial(df, graphing_columns = graphing_columns, sorting_algorithm = "None", default_sorting = "alphabetical", match_order = "advanced", color_bands=FALSE, verbose=TRUE, output_plot_path=file.path(output_dir, "GoT_unsorted_alphabetical.pdf"), min_text = 0.01, save_height = 24, save_width = 24)
p

p <- plot_alluvial(df, graphing_columns = graphing_columns, sorting_algorithm = "None", default_sorting = "reverse_alphabetical", match_order = "left", color_bands=FALSE, verbose=TRUE, output_plot_path=file.path(output_dir, "GoT_unsorted_reverse_alphabetical.pdf"), min_text = 0.01, save_height = 24, save_width = 24)
p

p <- plot_alluvial(df, graphing_columns = graphing_columns, sorting_algorithm = "None", default_sorting = "increasing", match_order = "left", color_bands=FALSE, verbose=TRUE, output_plot_path=file.path(output_dir, "GoT_unsorted_increasing.pdf"), min_text = 0.01, save_height = 24, save_width = 24)
p

p <- plot_alluvial(df, graphing_columns = graphing_columns, sorting_algorithm = "None", default_sorting = "decreasing", match_order = "left", color_bands=FALSE, verbose=TRUE, output_plot_path=file.path(output_dir, "GoT_unsorted_decreasing.pdf"), min_text = 0.01, save_height = 24, save_width = 24)
p
```

```{r}
p <- plot_alluvial(df, graphing_columns = graphing_columns, sorting_algorithm = "random", match_order="left", color_bands=FALSE, verbose=TRUE, output_plot_path=file.path(output_dir, "GoT_random.pdf"), min_text = 0.01, save_height = 24, save_width = 24)
p
...
```{r}
p <- plot_alluvial(df, graphing_columns = graphing_columns, sorting_algorithm = "neighbornet", optimize_column_order=FALSE, color_bands=FALSE, match_order = "left", min_text = 0.01, verbose=TRUE, output_plot_path=file.path(output_dir, "GoT_NN.pdf"), save_height = 24, save_width = 24)
p
